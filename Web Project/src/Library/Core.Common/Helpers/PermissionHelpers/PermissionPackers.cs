...
namespace Core.Common.Helpers.PermissionHelpers
{
    public static class PermissionPackers
    {
        ...
        public static List<Permissions> UnpackPermissionsFromString(this string packedPermissions)
        {
            return packedPermissions.UnpackPermissionValuesFromString().Select(x => ((Permissions)x)).ToList();
        }
